...
interface WidgetModalProps {
  isOpen: boolean;
  onClose: () => void;
  onAddWidget: (name: string, widgetType: WidgetType, preset?: Preset, thresholds?: Threshold[], metric?: MetricsWidget, genericMetrics?: GenericsMetrics,
  ) => void;
  ...
  const onSubmit = (data: WidgetForm) => {
    ...
    if (metric) {
      if (editingItem) {
        ...
        onAddWidget(data.widgetName, data.widgetType, undefined, undefined, metric, undefined);
        reset({
          widgetName: '',
          selectedPreset: '',
          widgetType: WidgetType.PRESET,
                ...
                render={({field}) => {
                  ...
                  >
                    {[
                      ...
                      {key: WidgetType.GENERICS_METRICS, value: 'Generic Metrics'},
