...
- `Authentication Type` : The type of authentication to use. Supported values are `NoAuth`, `Basic`, and `X-Scope-OrgID`.
...
### X-Scope-OrgID
- `X-Scope-OrgID`: The organization ID to use for Grafana Loki Multi-tenancy support.
