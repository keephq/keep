...
- `roomPrefix` - The room prefix of the incident.
- `isDrill` - The drill status of the incident.
- `status` - The status of the incident.
- `attachCaption` - The attachment caption of the incident.
- `attachURL` - The attachment URL of the incident.
