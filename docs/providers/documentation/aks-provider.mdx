...
3. Run `az ad sp create-for-rbac --role owner --scopes /subscriptions/8d7964b8-cdf5-4f9b-aa49-adf9b4cebfec` in the cloud shell, you will get response similar to:
   ```
    {
