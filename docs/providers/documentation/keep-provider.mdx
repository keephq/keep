...
- `workflow_to_update_yaml`: str : The YAML of a workflow to update in Keep. You may find [functions -> raw_render_without_execution](/workflow/syntax/functions.mdx) useful.
