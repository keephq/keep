...
- monitors_write (Monitors Write)
	Required: False
	Description: Write monitors. (**Required for auto-webhook integration*)
- create_webhooks (Integrations Manage)
	Required: False
	Description: Create webhooks integrations. (**Required for auto-webhook integration*)
 - metrics_read
	Required: False
	Description: View metrics.
 - logs_read (Logs Read Data)
	Required: False
	Description: View logs.
 - traces_read (APM Read)
	Required: False
	Description: Read APM traces.
