...
- Required for installing the Datadog Webhook Integration so all monitors will be pushed to Keep.

####
### `metrics:read`

- Required for querying any metric data.

### `logs:read`

- Required for querying log data.

### `traces:read`

- Required for querying APM trace data.
