...
Additional workflow samples are available in `examples/workflows/`:

- `feishu_servicedesk_simple.yml`
- `feishu_servicedesk_best_practice.yml`
- `feishu_servicedesk_with_email.yml`
