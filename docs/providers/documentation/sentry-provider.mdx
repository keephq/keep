...
7. Scroll down to the bottom of the screen to the `TOKENS` section and copy the generated token -- This is the API key you will be using in Keep.
...
- `project:write`
	| Required: `False`
	| Description: `Write permission for projects in an organization.` (**Required for auto-webhook integration*)
