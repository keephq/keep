...
**Description:** Applies a string method to a string with optional arguments.
**Example:**
...
steps:
  - name: example-step
    provider:
      type: mock
      with:
        message: keep.apply_str_method("hello world", "upper") # Output: "HELLO WORLD"
        replace_example: keep.apply_str_method("hello world", "replace", "world", "Keep") # Output: "hello Keep"
        split_example: keep.apply_str_method("a,b,c", "split", ",") # Output: ["a", "b", "c"]
