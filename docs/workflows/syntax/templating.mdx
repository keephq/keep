...
KeepHQ supports two templating engines for dynamic values inside workflow YAML definitions:

- Jinja2 — powerful and Pythonic
- Mustache — simple and logic-less
...
## 📦 Example: JiraOnPrem with Mustache (Default)
...
## 📦 Example: JiraOnPrem with Jinja2
