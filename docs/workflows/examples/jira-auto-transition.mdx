# Jira Auto-Transition Workflow Example

This example demonstrates how to automatically create Jira tickets when alerts fire and transition them to "Done" when alerts are resolved.
