...
**Note**: For Graylog v4.x please set the **URL** to `KEEP_BACKEND_URL/alerts/event/PROVIDER_TYPE?api_key={api_key}`.
...
- **URL**: KEEP_BACKEND_URL/alerts/event/PROVIDER_TYPE  # Whitelist this URL
