...
<Tip>To elaborate on resource provisioning and its configuration, please see [provisioning docs](provision/overview).</Tip>
...
<Tip>For specifc authentication type configuration, please see [authentication docs](authentication/overview).</Tip>
