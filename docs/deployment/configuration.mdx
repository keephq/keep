...
<Info>
  Frigade configuration controls Keep's integration with the Frigade onboarding
  platform.
</Info>
...
| **KEEP_HIDE_SENSITIVE_FIELDS** | Hides sensitive fields | False |  None  |   "true", "false"   |
...
### Noise reduction features disabling
<Info>
  To disable unnecessary links in the navigation bar, use the following environment variables.
</Info>
|           Env var              |                  Purpose                   | Required | Default Value |   Valid options   |
| :--------------------------:   | :----------------------------------------: | :------: | :-----------: | :---------------: |
|  **DISABLE_DEDUPLICATION**     | Disables deduplication of incoming alerts  |    No    |    "false"    | "true" or "false" |
|  **DISABLE_CORRELATION**       | Disables correlation of related alerts     |    No    |    "false"    | "true" or "false" |
|    **DISABLE_WORKFLOWS**       | Disables execution of workflows            |    No    |    "false"    | "true" or "false" |
| **DISABLE_SERVICE_TOPOLOGY**   | Disables service topology visualization    |    No    |    "false"    | "true" or "false" |
|     **DISABLE_MAPPING**        | Disables mapping of alert fields           |    No    |    "false"    | "true" or "false" |
|   **DISABLE_EXTRACTION**       | Disables extraction of alert details       |    No    |    "false"    | "true" or "false" |
| **DISABLE_MAINTENANCE_WINDOW** | Disables maintenance window functionality  |    No    |    "false"    | "true" or "false" |
|    **DISABLE_AI_PLUGINS**      | Disables AI plugin integrations            |    No    |    "false"    | "true" or "false" |
