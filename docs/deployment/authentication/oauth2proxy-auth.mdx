...
|--------------------|-----------|:--------:|:-------------:|
| AUTH_TYPE | Set to 'OAUTH2PROXY' for OAUTH2PROXY authentication | Yes | - |
| OAUTH2_PROXY_USER_HEADER | Header for the authenticated user's email | Yes | X-Auth-Request-Email |
| OAUTH2_PROXY_ROLE_HEADER | Header for the authenticated user's role | Yes | X-Auth-Request-Role |
| OAUTH2_PROXY_AUTO_CREATE_USER | Automatically create user if not exists | No | True |
