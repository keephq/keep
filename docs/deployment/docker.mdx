...
The docker-compose.yml contains 2 services:
- [keep-backend](https://console.cloud.google.com/artifacts/docker/keephq/us-central1/keep/keep-api?project=keephq) - a FastAPI service that serves the API and real-time SSE updates.
- [keep-frontend](https://console.cloud.google.com/artifacts/docker/keephq/us-central1/keep/keep-ui?project=keephq) - a Next.js app that serves the Keep UI interface.
