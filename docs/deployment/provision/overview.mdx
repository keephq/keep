...
4. [**Deduplication rules Provisioning**](/deployment/provision/deduplication-rule) - Configure and manage deduplication rules within Keep.
...
| **Deduplication rules**| `KEEP_DEDUPLICATION_RULES`     | Path to JSON file containing deduplication rules configurations or JSON itself |
