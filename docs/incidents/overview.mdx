...
### (25) Ticketing Integration
Keep provides comprehensive ticketing integration capabilities that allow you to create new tickets and link existing tickets to incidents. This feature supports multiple ticketing systems including Jira, ServiceNow, Linear, and more.

<Info>
For detailed information about ticketing features, including configuration and usage, see the [Ticketing Integration](/incidents/ticketing) documentation.
</Info>
