...
4. [Workflow Builder](platform/workflowbuilder) - a visual builder for your workflows (in beta 🚧).


<Tip>Keep is fully open source. If you want to start Keep on your local environment, see the deployment section.</Tip>
