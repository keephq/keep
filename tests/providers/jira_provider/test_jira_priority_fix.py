    ...
    def test_create_issue_excludes_empty_priority(self, jira_provider):
        ...
        responses.add(
            ...
            json={
                "id": "124",
                "key": "TEST-124",
                "self": "https://test.atlassian.net/rest/api/2/issue/124",
            },
            status=201,
        )
    ...
    def test_create_issue_excludes_null_priority(self, jira_provider):
        ...
        responses.add(
            ...
            json={
                "id": "125",
                "key": "TEST-125",
                "self": "https://test.atlassian.net/rest/api/2/issue/125",
            },
            status=201,
        )
    ...
    def test_create_issue_includes_valid_priority(self, jira_provider):
        ...
        responses.add(
            ...
            json={
                "id": "126",
                "key": "TEST-126",
                "self": "https://test.atlassian.net/rest/api/2/issue/126",
            },
            status=201,
        )
    ...
    def test_create_issue_preserves_other_custom_fields(self, jira_provider):
        ...
        responses.add(
            ...
            json={
                "id": "127",
                "key": "TEST-127",
                "self": "https://test.atlassian.net/rest/api/2/issue/127",
            },
            status=201,
        )
