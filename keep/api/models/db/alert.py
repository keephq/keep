...
class Incident(SQLModel, table=True):
    ...
    user_summary: str = Field(sa_column=Column(TEXT), max_length=1024, nullable=True)
    generated_summary: str = Field(sa_column=Column(TEXT), max_length=1024, nullable=True)
