...
def populate_db():
    ...
    for incident in incidents:
        ...
        stmt = (
            ...
            .values(
                sources=list(
                    {source for alert_dto in alerts_dto for source in alert_dto.source}
                ),
                affected_services=list(
                    {alert.service for alert in alerts_dto if alert.service is not None}
                ),
