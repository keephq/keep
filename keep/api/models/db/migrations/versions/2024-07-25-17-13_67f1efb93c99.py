...
def upgrade() -> None:
    ...
    op.add_column("incident", sa.Column("affected_services", sa.JSON(), nullable=False, server_default="[]"))
    op.add_column("incident", sa.Column("sources", sa.JSON(), nullable=False, server_default="[]"))
