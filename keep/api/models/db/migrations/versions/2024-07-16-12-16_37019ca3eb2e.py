...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "incident_fingerprint", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_incident_incident_fingerprint"),
        "incident",
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_incident_incident_fingerprint"), table_name="incident")
