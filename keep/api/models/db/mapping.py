...
class MappingRule(SQLModel, table=True):
    ...
    file_name: str | None = Field(max_length=255)
    ...
    updated_by: str | None = Field(max_length=255, default=None)
    last_updated_at: datetime = Field(default_factory=datetime.utcnow)
    # Multi-level mapping fields
    is_multi_level: bool = Field(default=False)
    new_property_name: str | None = Field(max_length=255)
    prefix_to_remove: str | None = Field(max_length=255)
    ...
    provisioned_file: str | None = Field(default=None)
