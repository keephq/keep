...
class AzuremonitoringProvider(BaseProvider):
    ...
    webhook_template = ""
    webhook_markdown = """
💡 For more details on how to configure Azure Monitor to send alerts to Keep, see the [Keep documentation](https://docs.keephq.dev/docs/integrations/azure-monitor). 💡
