"""Flock provider for team messaging."""
...
class FlockProviderAuthConfig:
    webhook_url: str = dataclasses.field(
        metadata={"required": True, "description": "Flock Webhook URL", "sensitive": True},
        default=""
    )
...
class FlockProvider(BaseProvider):
    ...
    def validate_config(self):
        self.authentication_config = FlockProviderAuthConfig(**self.config.authentication)
    ...
    def _notify(self, text: str = "", **kwargs: Dict[str, Any]):
        ...
        try:
            ...
            raise ProviderException(f"Flock API error: {e}")

        self.logger.info("Flock message sent")
