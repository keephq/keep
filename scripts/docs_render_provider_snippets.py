...
def main():
    ...
    parser.add_argument(
        "--check",
        action="store_true",
        help="Check if the generated snippets are up-to-date, otherwise exception",
    )
    args = parser.parse_args()

    if args.check:
        print("Checking if Provider documentation snippets are up-to-date...")
    else:
    ...
    for provider_name, provider_data in providers.items():
        ...
        # Check if file exists and override if content is different.
    ...
    if args.check and outdated_files:
